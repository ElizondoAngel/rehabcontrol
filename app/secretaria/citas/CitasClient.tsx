  ...
  return (
    ...
    <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Safari/Chrome móvil a veces ignoran el width:100% en inputs de
           fecha/hora por su ancho mínimo interno, y el widget nativo del
           selector agrega su propio alto — se los forzamos aparte. */
        input[type="date"].form-input,input[type="time"].form-input{
